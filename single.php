...
<head>
  ...
  <meta name="description"
    content="<?php echo mb_strimwidth(strip_tags(apply_filters('the_content', $post->post_content)), 0, 200,"... "); ?>" />
    ...
    <div class="header clearfix">
      <div class="pc">
        ...
        <ul class="nav">
          ...
          <li
            class="<?php if ( (is_category('1') || in_category('1')) && !is_page() && !is_home() ) { echo 'current'; } ?>">
            <a href="/web/"><i class="iconfont">&#xe87e;</i>web前端开发</a></li>
          <li
            class="<?php if ( (is_category('3') || in_category('3')) && !is_page() && !is_home() ) { echo 'current'; } ?>">
            <a href="/javascript/"><i class="iconfont">&#xe6df;</i>Javascript资源</a></li>
          <li
            class="<?php if ( (is_category('2') || in_category('2')) && !is_page() && !is_home() ) { echo 'current'; } ?>">
            <a href="/html5css3/"><i class="iconfont">&#xe6dd;</i>HTML5资源</a></li>
          <li
            class="<?php if ( (is_category('5') || in_category('5')) && !is_page() && !is_home() ) { echo 'current'; } ?>">
            <a href="/bloginfo/"><i class="iconfont">&#xe876;</i>关于博主</a></li>
    ...
    <div class="center clearfix">
      ...
      <div class="left">
        ...
        <div class="left_list text_info article">
          ...
          <div class="article_info"><span>发布日期：<?php the_time('Y年m月d日') ?>
            </span><span>分类：<?php echo get_the_category()[0]->cat_name; ?></span><span> 作者： <?php the_author(); ?>
            </span><span>阅读：<?php echo getPostViews(get_the_ID()); ?> </span>
          </div>
          <?php the_content(); ?>
        </div>
        <?php endwhile; else : ?>
        ...
        <div class="left_list text_info">
          <h3>
            上一篇：<?php if (get_previous_post()) { previous_post_link('<span></span>%link');} else {echo "没有了，已经是最后文章";} ?>
          </h3>
    ...
    while (have_posts()) {
      the_post(); update_post_caches($posts); ?>
              ...
              <li>
                ...
                echo '<img src="http://www.huangguorui.cn/wp-content/themes/h/img/404.jpg" alt="<?php the_title(); ?>">';?>
              ...
              <li>
                <a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
                  ...
                  if ( has_post_thumbnail() )
                    ...
                    echo '<img src="http://www.huangguorui.cn/wp-content/themes/h/img/404.jpg" alt="<?php the_title(); ?>">';?>
                  <span> <?php substr(the_title(), 0,10) ; ?></span>
                </a>
              </li>
